        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="auditStatus">
                        <Select v-model="searchForm.auditStatus" placeholder="审批状态" clearable style="width: 150px">
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: "md-checkmark",
                                        ghost: true,
                                        disabled: params.row.auditStatus != "未审批" || !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("enable"))
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
                                    on: {
                                        click: () => {
                                            this.auditAgreementFx(params.row);
                                        }
                                    }
                                },
                                "通过"
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: "md-close",
                                        ghost: true,
                                        disabled: params.row.auditStatus != "未审批" || !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("disable"))
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
                                    on: {
                                        click: () => {
                                            this.notAuditAgreementFx(params.row);
                                        }
                                    }
                                },
                                "驳回"
